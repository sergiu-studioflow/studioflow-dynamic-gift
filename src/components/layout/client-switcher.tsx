        ...
        <div className="absolute left-0 right-0 top-full z-50 mt-1 overflow-hidden rounded-lg border border-white/15 bg-[#1a1a1f] shadow-xl">
          ...
          <div className="max-h-[320px] overflow-y-auto py-1">
            ...
            >
              ...
              {isAllClients && (
                <div className="h-1.5 w-1.5 rounded-full bg-[var(--brand-primary,#23c3e8)]" />
              )}
            </button>
                ...
                {clusterClients.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <div className="ml-auto h-1.5 w-1.5 rounded-full bg-[var(--brand-primary,#23c3e8)] flex-shrink-0" />
                      )}
                    </button>
                  );
                })}
